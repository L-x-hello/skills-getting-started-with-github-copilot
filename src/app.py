...
if __name__ == "__main__":
    # Allow running the app directly with `python app.py` for development.
    # uvicorn is listed in requirements.txt; import here to avoid requiring it at module import time.
    import uvicorn
